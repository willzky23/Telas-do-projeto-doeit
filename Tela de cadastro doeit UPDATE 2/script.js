document.addEventListener("DOMContentLoaded", function () {
    ...
    const passwordInput = document.querySelector(".campos3");
    const confirmPasswordInput = document.querySelector(".campos4");
    const togglePassword = document.querySelector(".olho");
    const toggleConfirmPassword = document.querySelector(".olho1");
